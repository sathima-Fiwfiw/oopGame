...
public class itselfgame extends JFrame {
    ...
    itselfgame(String characterID,String nameUser,String IP) {
        ...
        showReadyThread = new showReady(timecount,candyFallThread, handgrost);
...
class PanelGame extends JPanel implements MouseMotionListener, MouseListener {
   ...
   // Timer showReadyTimer;
    ...
    PanelGame(itselfgame ingame,tradetime timecount , ThreadRain candyFallThread,  ThreadHand handgrost, showReady showReadyThread) {
        this.ingame = ingame;
