...
public class GameClient extends JFrame {
    ...
    void loadImages() {
            ...
            for (int i = 0; i < character.length; i++) {
                ...
                character[i] = Toolkit.getDefaultToolkit().createImage(imagePath);
            }
            for (int i = 0; i < Candys; i++) {
                String imagePath = System.getProperty("user.dir") + File.separator + "imageRain" + File.separator + ((i % 10) + 1) + ".png";
                Candy[i] = Toolkit.getDefaultToolkit().createImage(imagePath);
            }
    ...
    private void createAndShowGUI() {
        ...
        panel.setLayout(null);
          ...
          File.separator + "ingame" + File.separator + "buttonScore.png"); 
