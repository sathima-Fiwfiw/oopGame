...
class panalAbout2 extends JPanel {
    ...
    Image imageBgk =Toolkit.getDefaultToolkit().createImage(System.getProperty("user.dir") +
    File.separator + "imgeAbout" + File.separator + "BKG.png");
    JButton buttonMenu;
    JButton buttonBack;
    ...
    panalAbout2(about2 abt2) {
        ...
        ImageIcon iconMenu = new ImageIcon(System.getProperty("user.dir") + 
        File.separator +"imgeAbout"+ File.separator + "bb1.png");
        ImageIcon iconBack =new ImageIcon(System.getProperty("user.dir") + 
