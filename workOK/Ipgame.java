...
class CustomPanel extends JPanel {
    ...
    CustomPanel(Ipgame ipgame) {
        ...
        File.separator + "imageip" + File.separator + "bg.png");
        ...
        add(textip);
            ...
            for (int i = 0; i < buttons.length; i++) {
                ...
                ImageIcon character = new ImageIcon(System.getProperty("user.dir") + 
                                File.separator +"imageip"+ File.separator + (i + 1) + ".png"); 
                Image scaledImage = character.getImage().getScaledInstance(200, 300, Image.SCALE_SMOOTH); // Adjust the size here
            ...
            File.separator + "imageip" + File.separator + "enter.png"); 
            ...
            enter.addActionListener(new ActionListener() {
                ...
                SwingUtilities.invokeLater(() -> {
                    WaitingRoom waitingRoom = new WaitingRoom(name, ip, getCharacter());
            ...
            File.separator + "imgeAbout" + File.separator + "bb3.png"); 
