...
class panalAbout extends JPanel {
    ...
    Image imageBg = Toolkit.getDefaultToolkit().createImage(System.getProperty("user.dir") +
    File.separator + "imgeAbout" + File.separator + "getCandy.png");
    JButton buttonMenu1;
    JButton buttonNext;
    about abt;
    ...
    panalAbout(about abt) {
        ...
        ImageIcon iconMenu1 = new ImageIcon(System.getProperty("user.dir") + 
        File.separator +"imgeAbout"+ File.separator + "bb1.png");
        ImageIcon iconNext =new  ImageIcon(System.getProperty("user.dir") + 
        File.separator +"imgeAbout"+ File.separator + "bb2.png");
